...
fig = plt.figure()
plt.subplot(1,1,1)
plt.scatter(x, y, color = 'purple', marker = '*', linewidth = 2)
...
fig_3d = plt.figure()
fig_3d.add_subplot(1,1,1, projection = '3d')
constellation3d = plt.scatter(x, y, z, color = 'purple', marker = 's', linewidth = 7)
plt.title('3D Visualization of the Orion Constellation')
plt.xlabel('x coordinates')
plt.ylabel('y coordinates')
ax = plt.scatter(x, y, z, color = 'purple', marker = 's', linewidth = 7)
